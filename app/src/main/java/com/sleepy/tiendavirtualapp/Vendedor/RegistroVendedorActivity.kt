...
import com.sleepy.tiendavirtualapp.databinding.ActivityRegistroVendedorBinding
...
class RegistroVendedorActivity : AppCompatActivity() {
    ...
    private fun validarInformacion() {
        ...
        if(nombres.isEmpty()){
            ...
            binding.etPassword.error= "Necesitas 6 o más carac."
            binding.etPassword.requestFocus()
    ...
    private fun insertarInfoBD(){
        ...
        references.child(uidBD!!)
            ...
            .addOnFailureListener {e->
                progressDialog.dismiss()
                Toast.makeText(this , "Falló el registro a BD debido a ${e.message}", Toast.LENGTH_SHORT).show()
